...
export default function SubmissionForm({submission} : {submission: SubmissionInputs}) {
    ...
    return (
      <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <label>Submitter Email* {errors.email && <span className="form_error">Enter a valid email</span>}</label>
            <input
            ...
            <label>Block Association Name* {errors.block_association_name && <span className="form_error">This field is required</span>}</label>
            <input
            ...
            <label>Block Association Boundaries* {errors.block_association_boundaries && <span className="form_error">This field is required</span>}</label>
            <input
            ...
            <label>Block Association Email {errors.block_association_email && <span className="form_error">Enter a valid email</span>}</label>
            <input
            ...
            <label>Block Association Phone {errors.block_association_phone && <span className="form_error">Check the phone number</span>}</label>
            <input
                ...
                {...register("block_association_phone", {
                    onBlur: (e) => setValue("block_association_phone", formatPhone(e.target.value)),
                    validate: {
                        pattern: (val) => val.trim() === "" || /^[0-9()+\-.\s]*$/.test(val) || "Use numbers and phone symbols",
                        length: (val) => val.trim() === "" || val.replace(/\D/g, "").length <= 15 || "Phone number is too long",
                    },
                })}
            />
